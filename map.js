...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // --- UI 元素定義 ---
    const ui = {
        messageElement: document.getElementById('message') || document.getElementById('message-desktop'),
    ...
    // --- 初始化 ---
    // 明確指定在哪個 div 中繪圖
    celestialConfig.container = "celestial-map"; 
